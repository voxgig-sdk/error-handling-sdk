# ErrorHandling SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ErrorHandlingSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ErrorHandlingSDK(...) and ErrorHandlingSDK.test(...) become
#      ErrorHandlingSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "errorhandling_sdk"
_SDK_CLASS = "ErrorHandlingSDK"
