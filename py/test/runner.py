...
class ErrorHandlingTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ErrorHandlingTestRunner.getenv("ERRORHANDLING_TEST_LIVE")
        override = ErrorHandlingTestRunner.getenv("ERRORHANDLING_TEST_OVERRIDE")
        ...
        explain = ErrorHandlingTestRunner.getenv("ERRORHANDLING_TEST_EXPLAIN")
