...
from errorhandling_sdk.utility import register

# Load features
from errorhandling_sdk.feature.base_feature import ErrorHandlingBaseFeature
from errorhandling_sdk.features import _has_feature, _make_feature
...
class ErrorHandlingSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ErrorHandlingUtility()
        self._utility = utility

        from errorhandling_sdk.config import shared_config
    ...
    def get_utility(self):
        return ErrorHandlingUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ErrorHandlingSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def LogoGeneration(self, data=None) -> "LogoGenerationEntity":
        ...
        from errorhandling_sdk.entity.logo_generation_entity import LogoGenerationEntity
