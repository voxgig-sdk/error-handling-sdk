# ErrorHandling Python SDK



The Python SDK for the ErrorHandling API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/error-handling-sdk/releases)) or
...
```
py/
├── errorhandling_sdk.py         -- Main SDK module
