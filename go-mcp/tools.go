...
func registerTools(server *mcp.Server, client *sdk.ErrorHandlingSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "error-handling_list",
		Description: "List records from ErrorHandling. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "error-handling_load",
		Description: "Load a single record from ErrorHandling. " +
...
func runOp(client *sdk.ErrorHandlingSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ErrorHandlingSDK, name string) (sdk.ErrorHandlingEntity, error) {
