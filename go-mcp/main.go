// Command ErrorHandling-mcp is an MCP server exposing the ErrorHandling
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ErrorHandling_list  — list records of an entity
//	ErrorHandling_load  — load a single record of an entity
//
