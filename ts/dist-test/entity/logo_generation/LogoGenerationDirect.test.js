...
(0, node_test_1.describe)('LogoGenerationDirect', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('ERROR_HANDLING_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ErrorHandlingSDK({
...
function liveScenariosActive() { return false && process.env.ERROR_HANDLING_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ErrorHandlingSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['ERROR_HANDLING_TEST_LOGO_GENERATION_ENTID'];
    ...
    const client = new __1.ErrorHandlingSDK({
        base: 'http://localhost:8080',
