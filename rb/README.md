# ErrorHandling Ruby SDK



The Ruby SDK for the ErrorHandling API — an entity-oriented client using idiomatic Ruby conventions.
...
- Releases: [https://github.com/voxgig-sdk/error-handling-sdk/releases](https://github.com/voxgig-sdk/error-handling-sdk/releases)
...
```ruby
client = ErrorHandlingSDK.test(testopts, sdkopts)
```
...
raise a `ErrorHandlingError` (a `StandardError` subclass), so wrap
...
```
rb/
├── ErrorHandling_sdk.rb       -- Main SDK module
...
The main module (`ErrorHandling_sdk`) exports the SDK class
