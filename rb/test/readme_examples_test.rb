...
#      offline in seeded test mode (ErrorHandlingSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ErrorHandling_sdk.rb")
  SDK_CLASS = "ErrorHandlingSDK"
