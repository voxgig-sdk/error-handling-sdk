...
class LogoGenerationEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set ERROR_HANDLING_TEST_LOGO_GENERATION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def logo_generation_basic_setup(extra)
  ...
  entid_env_raw = ENV["ERROR_HANDLING_TEST_LOGO_GENERATION_ENTID"]
