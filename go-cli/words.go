...
func registerSDKWords(r *eng.Registry, client *sdk.ErrorHandlingSDK) {
...
func runOp(client *sdk.ErrorHandlingSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
