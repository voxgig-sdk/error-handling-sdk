// Command ErrorHandling-cli is a CLI + REPL for the ErrorHandling SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      ERROR_HANDLING_APIKEY (api key), ERROR_HANDLING_BASE (base url override)")
