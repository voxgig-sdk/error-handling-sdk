# ErrorHandling SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, ErrorHandlingError):
        errmsg = err.msg
    ...
    msg = "ErrorHandlingSDK: " + opname + ": " + errmsg
    ...
    sdk_err = ErrorHandlingError("", msg, ctx)
