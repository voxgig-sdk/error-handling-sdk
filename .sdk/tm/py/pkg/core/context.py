...
from projectname_sdk.core.control import ErrorHandlingControl
...
class ErrorHandlingContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ErrorHandlingControl()
        ...
        if isinstance(sp, ErrorHandlingSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ErrorHandlingResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ErrorHandlingResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ErrorHandlingError(code, msg, self)
