...
// ErrorHandling SDK utility: graphql
//
...
class ErrorHandlingGraphql
{
    ...
    // equivalent.
    public static function body(ErrorHandlingContext $ctx): mixed
    {
    ...
    public static function errors(ErrorHandlingContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
