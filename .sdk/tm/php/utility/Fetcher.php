...
// ErrorHandling SDK utility: fetcher

class ErrorHandlingFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ErrorHandlingSDK/1.0)';
    ...
    public static function call(ErrorHandlingContext $ctx, string $fullurl, array $fetchdef): array
    {
