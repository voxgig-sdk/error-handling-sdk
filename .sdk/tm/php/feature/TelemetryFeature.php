...
// ErrorHandling SDK telemetry feature
...
class ErrorHandlingTelemetryFeature extends ErrorHandlingBaseFeature
{
    ...
    private function _close(ErrorHandlingContext $ctx, bool $ok): void
    {
