...
// ErrorHandling SDK debug feature
...
class ErrorHandlingDebugFeature extends ErrorHandlingBaseFeature
{
    ...
    private function _finish(ErrorHandlingContext $ctx, bool $ok): void
    {
