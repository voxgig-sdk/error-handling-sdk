...
// ErrorHandling SDK proxy feature
...
class ErrorHandlingProxyFeature extends ErrorHandlingBaseFeature
{
    ...
    public function init(ErrorHandlingContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ErrorHandlingContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
