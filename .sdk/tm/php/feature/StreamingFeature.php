...
// ErrorHandling SDK streaming feature
...
class ErrorHandlingStreamingFeature extends ErrorHandlingBaseFeature
{
    ...
    private function _iterate(ErrorHandlingResult $result): \Generator
    {
    ...
    private function _streamable(ErrorHandlingContext $ctx): bool
    {
