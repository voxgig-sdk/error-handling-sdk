...
// ErrorHandling SDK idempotency feature
...
class ErrorHandlingIdempotencyFeature extends ErrorHandlingBaseFeature
{
    ...
    private function _mutating(ErrorHandlingContext $ctx): bool
    {
