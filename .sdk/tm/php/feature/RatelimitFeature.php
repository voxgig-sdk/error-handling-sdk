...
// ErrorHandling SDK ratelimit feature
...
class ErrorHandlingRatelimitFeature extends ErrorHandlingBaseFeature
{
    ...
    private function _acquire(ErrorHandlingContext $ctx): void
    {
    ...
    private function _track(ErrorHandlingContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
