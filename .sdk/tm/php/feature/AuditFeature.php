...
// ErrorHandling SDK audit feature
...
class ErrorHandlingAuditFeature extends ErrorHandlingBaseFeature
{
    ...
    private function _emit(ErrorHandlingContext $ctx, string $outcome): void
    {
