...
// ErrorHandling SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ErrorHandlingOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ErrorHandlingOmni::structfix($now, Struct::undef()))
                        !== json_encode(ErrorHandlingOmni::structfix($val, Struct::undef()))) {
