...
|---|---|---|
| `ts/` | @voxgig-sdk/error-handling-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/error-handling-sdk \
      --repository voxgig-sdk/error-handling-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/error-handling-sdk` shows it, and
`npm trust revoke @voxgig-sdk/error-handling-sdk --id=<id>` removes it.
