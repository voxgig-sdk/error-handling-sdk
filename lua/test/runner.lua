...
function runner.env_override(m)
  local live = runner.getenv("ERRORHANDLING_TEST_LIVE")
  local override = runner.getenv("ERRORHANDLING_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ERRORHANDLING_TEST_EXPLAIN")
