...
func (sdk *ErrorHandlingSDK) OptionsMap() map[string]any {
...
func (sdk *ErrorHandlingSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ErrorHandlingSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ErrorHandlingSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ErrorHandlingSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ErrorHandlingSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ErrorHandlingSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ErrorHandlingSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ErrorHandlingSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ErrorHandlingSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ErrorHandlingSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *ErrorHandlingSDK {
	...
	sdk := NewErrorHandlingSDK(sdkopts)
	sdk.Mode = "test"
