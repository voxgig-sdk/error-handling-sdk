...
// ErrorHandling SDK metrics feature
...
class ErrorHandlingMetricsFeature extends ErrorHandlingBaseFeature
{
    ...
    private function _record(ErrorHandlingContext $ctx, bool $ok): void
    {
