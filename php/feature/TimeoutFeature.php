...
// ErrorHandling SDK timeout feature
...
class ErrorHandlingTimeoutFeature extends ErrorHandlingBaseFeature
{
    ...
    private function _with_timeout(ErrorHandlingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ErrorHandlingContext $_ctx, float $ms): void
    {
        $client = $this->client;
