...
// ErrorHandling SDK cache feature
...
class ErrorHandlingCacheFeature extends ErrorHandlingBaseFeature
{
    ...
    private function _through(ErrorHandlingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
