...
// ErrorHandling SDK clienttrack feature
...
class ErrorHandlingClienttrackFeature extends ErrorHandlingBaseFeature
{
    ...
    public function PostConstruct(ErrorHandlingContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ErrorHandling-SDK';
