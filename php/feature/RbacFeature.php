...
// ErrorHandling SDK rbac feature
...
class ErrorHandlingRbacFeature extends ErrorHandlingBaseFeature
{
    ...
    private function _required(ErrorHandlingContext $ctx): ?string
    {
    ...
    private function _reject(ErrorHandlingContext $ctx, string $required): void
    {
    ...
    private function _track(ErrorHandlingContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
