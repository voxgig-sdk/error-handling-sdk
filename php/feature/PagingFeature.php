...
// ErrorHandling SDK paging feature
...
class ErrorHandlingPagingFeature extends ErrorHandlingBaseFeature
{
    ...
    private function _is_list(ErrorHandlingContext $ctx): bool
    {
