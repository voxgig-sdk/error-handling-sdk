...
// ErrorHandling SDK netsim feature
...
class ErrorHandlingNetsimFeature extends ErrorHandlingBaseFeature
{
    ...
    private function _simulate(ErrorHandlingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ErrorHandlingContext $ctx, array $applied): void
    {
        $client = $this->client;
