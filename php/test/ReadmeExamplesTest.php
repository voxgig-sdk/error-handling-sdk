...
// ErrorHandling SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ErrorHandlingSDK::test)
...
{
    private const SDK_CLASS = 'ErrorHandlingSDK';
    ...
    private const SDK_BASE = 'errorhandling_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../errorhandling_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
