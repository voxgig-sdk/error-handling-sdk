...
class LogoGenerationEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ERROR_HANDLING_TEST_LOGO_GENERATION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function logo_generation_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ERROR_HANDLING_TEST_LOGO_GENERATION_ENTID");
    ...
    if ($env["ERROR_HANDLING_TEST_LIVE"] === "TRUE") {
